...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 21-10-2024 a las 06:27:36
...
ALTER TABLE `personas`
  ...
  ADD KEY `fk_municipio_persona` (`id_municipio`);
...
--
ALTER TABLE `detalle_inmueble`
  ADD CONSTRAINT `fk_inmueble_detalle_inmueble` FOREIGN KEY (`id_inmueble`) REFERENCES `inmueble` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ALTER TABLE `detalle_inmueble_pago`
  ...
  ADD CONSTRAINT `fk_detalle_inmuble_detalle_inmueble_pago` FOREIGN KEY (`id_detalle_inmueble`) REFERENCES `detalle_inmueble` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_persona_detalle_inmuble_pago` FOREIGN KEY (`id_persona`) REFERENCES `personas` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `detalle_inmueble_persona`
--
ALTER TABLE `detalle_inmueble_persona`
  ADD CONSTRAINT `fk_detalle_inmuble_detalle_inmueble_persona` FOREIGN KEY (`id_detalle_inmueble`) REFERENCES `detalle_inmueble` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_persona_detalle_inmuble_persona` FOREIGN KEY (`id_persona`) REFERENCES `personas` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `inmueble`
--
ALTER TABLE `inmueble`
  ADD CONSTRAINT `fk_tipo_inmueble_inmueble` FOREIGN KEY (`id_tipo_inmueble`) REFERENCES `tipo_inmueble` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `municipio`
--
ALTER TABLE `municipio`
  ADD CONSTRAINT `fk_departamento_municipio` FOREIGN KEY (`id_departamento`) REFERENCES `departamento` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `personas`
--
ALTER TABLE `personas`
  ADD CONSTRAINT `fk_municipio_persona` FOREIGN KEY (`id_municipio`) REFERENCES `municipio` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `usuario`
--
ALTER TABLE `usuario`
  ADD CONSTRAINT `fk_persona_usuario` FOREIGN KEY (`id_persona`) REFERENCES `personas` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_rol_usuario` FOREIGN KEY (`id_rol`) REFERENCES `rol` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
COMMIT;
